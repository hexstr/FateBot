#ifndef MSGPACK11_HEADER
#define MSGPACK11_HEADER
...
namespace msgpack11 {
    ...
    public:
        ...
        template <class M, typename std::enable_if<
                               std::is_constructible<MsgPack, typename M::key_type>::value && std::is_constructible<MsgPack, typename M::mapped_type>::value,
                               int>::type = 0>
